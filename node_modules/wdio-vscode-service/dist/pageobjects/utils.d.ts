...
export declare abstract class BasePage<PageLocators, LocatorMap extends Record<string, Locators> = VSCodeLocatorMap> {
     ...
     * @returns thenable self reference
     */
    poll(timeout?: number, interval?: number): Promise<this>;
}
/**
 ...
 */
export declare function semverGte(version: string, targetVersion: string): boolean;
/**
 * Semver utility function that handles the special case where version is 'stable'
 * @param version The version to compare
 * @param targetVersion The target version to compare against
 ...
 */
export declare function semverLt(version: string, targetVersion: string): boolean;
export {};
